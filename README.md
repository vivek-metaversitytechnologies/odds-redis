...
Ball-by-ball API discovery and Socket.IO tick observations are written together per ball line,
for example `logs/ball-by-ball/ball-line-17.2-YYYY-MM-DD.log`. Each record has a monotonically
